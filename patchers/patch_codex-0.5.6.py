...
.coxSideClosed body{padding-right:var(--cox-rail)!important}
.coxSideClosed .coxSidebar{width:var(--cox-rail)}
.coxSideClosed .coxHead{flex-direction:column;height:auto;padding:6px 0;gap:4px;border-bottom:0}
.coxSideClosed .coxTitle,.coxSideClosed .coxSearchWrap,.coxSideClosed .coxList,.coxSideClosed .coxNewBtn .coxNewLbl{display:none}
.coxSideClosed .coxResize{display:none}
.coxSideClosed .coxNewBtn{width:32px;height:32px;margin:2px auto 0;padding:0}
...
`;
    ...
    function ensureShell(){
      ...
      shell.querySelector(".coxNewBtn").addEventListener("click",()=>{ clickNative(["[aria-label*='new task' i]","[aria-label*='new chat' i]","[aria-label*='new codex' i]","[aria-label*='new conversation' i]","[aria-label*='new session' i]","[aria-label*='compose' i]","[title*='new task' i]","[title*='new session' i]"]); });
