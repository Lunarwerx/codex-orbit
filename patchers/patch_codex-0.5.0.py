...
.coxSideClosed .coxTitle,.coxSideClosed .coxCount,.coxSideClosed .coxSearchWrap,.coxSideClosed .coxList{display:none}
.coxSideClosed .coxHead{padding:0 6px;justify-content:center;border-bottom:0}
`;
