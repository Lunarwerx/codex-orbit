...
.coxSpin{width:9px;height:9px;flex:0 0 9px;border-radius:50%;border:1.6px solid var(--vscode-descriptionForeground,#555);border-top-color:var(--vscode-charts-blue,#3b82f6);animation:coxspin .7s linear infinite}
